...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        // Obey experiment-specific threshold or verified certificate presence
        const isSimComplete = milestones.length >= reqCount || totalDbEvents >= reqCount || !!certRes.rows[0];
