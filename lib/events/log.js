...
// Dynamic semantic milestone resolver across all experiments 1–6
function resolveMilestoneFromEvent(expId, stage, eventType, payload) {
    ...
    // 1. Direct explicit milestone header (e.g. "Milestone: 6A_STATIC_NAT")
    ...
    // 3. Robust Semantic Mapping for Experiments 1–5
    switch (expId) {
        case 1:
