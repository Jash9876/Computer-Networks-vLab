...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        // 1. Audit Log into simulation_events
        await query(
        ...
        // 2. Authoritative Evidence Verification
        ...
        await query(
            `INSERT INTO experiment_progress (student_id, experiment_id, status, progress_percentage, completed_milestones, completed_at, last_activity)
             ...
             SET status = $3,
                 ...
                 last_activity = NOW()`,
            [user.id, expId, status, finalProgressPercentage, JSON.stringify(milestones), isAcademicComplete ? new Date() : null]
        );
