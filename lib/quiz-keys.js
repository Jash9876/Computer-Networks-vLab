...
const QUIZ_ANSWER_KEYS = {
    ...
    // Experiment 2: Study of IP Addressing & Cable Pinout Construction (6 Questions)
    2: [
        ...
        { id: 5, correctIndex: 2 }  // TTL=128 Windows device
    ],
    ...
    // Experiment 4: Design of Subnet IP Addressing in Packet Tracer (6 Questions)
    4: [
        ...
        { id: 5, correctIndex: 2 }  // Router1 has no static route back to PC0's network
    ],
