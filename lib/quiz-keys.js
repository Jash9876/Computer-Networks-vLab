...
const QUIZ_ANSWER_KEYS = {
    ...
    // Experiment 7: Demonstration of Routing Information Protocol (RIP v1 & RIP v2) (5 Questions)
    7: [
        { id: 0, correctIndex: 1 }, // Distance Vector — routers share routing tables with directly connected neighbours
        { id: 1, correctIndex: 1 }, // The network is unreachable — hop count 16 represents infinity in RIP
        { id: 2, correctIndex: 1 }, // RIP v1 does not include subnet-mask information in routing updates
        { id: 3, correctIndex: 1 }, // It prevents RIP v2 from automatically collapsing individual /27 subnets
        { id: 4, correctIndex: 2 }  // Routes dynamically learned from neighbouring router through RIP ('R')
    ],

    // Experiment 8: Single Area & Multi-Area OSPF Configuration (5 Questions)
    8: [
        { id: 0, correctIndex: 2 }, // 110 (Administrative Distance)
        { id: 1, correctIndex: 1 }, // Dijkstra's Shortest Path First (SPF) Algorithm
        { id: 2, correctIndex: 0 }, // To ensure loop-free inter-area routing
        { id: 3, correctIndex: 1 }, // Maintains LSDBs and floods Type 3 Summary LSAs
        { id: 4, correctIndex: 1 }  // 0.0.0.255 (Wildcard mask for /24)
    ],

    // Experiment 9: Configuration of Point-to-Point Protocol (PPP) & HDLC Protocol (5 Questions)
    9: [
        { id: 0, correctIndex: 0 }, // encapsulation ppp
        { id: 1, correctIndex: 1 }, // ppp authentication chap
        { id: 2, correctIndex: 1 }, // local database entry matching remote peer's hostname and shared secret
        { id: 3, correctIndex: 2 }, // show controllers serial0/1/0
        { id: 4, correctIndex: 1 }  // HDLC
    ],

    // Experiment 10: Configuration of Border Gateway Protocol (BGP) (5 Questions)
    10: [
        { id: 0, correctIndex: 1 }, // TCP port 179
        { id: 1, correctIndex: 2 }, // Path-Vector Exterior Gateway Protocol
        { id: 2, correctIndex: 0 }, // 20 (Administrative Distance for eBGP)
        { id: 3, correctIndex: 1 }, // network 192.168.10.0 mask 255.255.255.0
        { id: 4, correctIndex: 2 }  // Established
    ]
};
