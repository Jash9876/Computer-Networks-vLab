        ...
        function resolveMilestone(expId, stage, eventType, payload) {
            ...
            switch (expId) {
                ...
                case 7: {
                    ...
                    if (stgLower.includes('7a_router0') || (actLower.includes('router0') && actLower.includes('rip') && stgLower.includes('7a'))) res.push('7A_ROUTER0_RIP');
                    if (stgLower.includes('7a_router1') || (actLower.includes('router1') && actLower.includes('rip') && stgLower.includes('7a'))) res.push('7A_ROUTER1_RIP');
                    if (stgLower.includes('7a_converged') || actLower.includes('7a converged') || (actLower.includes('show ip route') && stgLower.includes('7a'))) res.push('7A_CONVERGED');
                    if (stgLower.includes('7a_connectivity') || ((eventType === 'PING_SUCCESS' || actLower.includes('ping')) && stgLower.includes('7a'))) res.push('7A_CONNECTIVITY');
                    
                    if (stgLower.includes('7b_router0') || (actLower.includes('router0') && actLower.includes('ripv2') && stgLower.includes('7b'))) res.push('7B_ROUTER0_RIPV2');
                    if (stgLower.includes('7b_router1') || (actLower.includes('router1') && actLower.includes('ripv2') && stgLower.includes('7b'))) res.push('7B_ROUTER1_RIPV2');
                    if (stgLower.includes('7b_converged') || actLower.includes('7b converged') || (actLower.includes('show ip route') && stgLower.includes('7b'))) res.push('7B_CONVERGED');
                    if (stgLower.includes('7b_connectivity') || ((eventType === 'PING_SUCCESS' || actLower.includes('ping')) && stgLower.includes('7b'))) res.push('7B_CONNECTIVITY');
                    break;
                }
                case 8: {
                    const actLower = act.toLowerCase();
                    ...
                    // Part 8A
                    if (stgLower.includes('8a_topology') || (stgLower.includes('topology') && (stgLower.includes('8a') || mode === '8A')) || (eventType === 'TOPOLOGY_VALIDATED' && (stgLower.includes('8a') || mode === '8A'))) res.push('8A_TOPOLOGY_COMPLETE');
                    if (stgLower.includes('8a_ip') || (stgLower.includes('addressing') && (stgLower.includes('8a') || mode === '8A')) || (eventType === 'ADDRESSING_MATCHED' && (stgLower.includes('8a') || mode === '8A'))) res.push('8A_IP_CONFIGURED');
                    if (stgLower.includes('8a_ospf') || (stgLower.includes('ospf') && (stgLower.includes('8a') || mode === '8A')) || (actLower.includes('router ospf') && (stgLower.includes('8a') || mode === '8A'))) res.push('8A_OSPF_CONFIGURED');
                    if (stgLower.includes('8a_connectivity') || (eventType === 'PING_SUCCESS' && (stgLower.includes('8a') || mode === '8A')) || (actLower.includes('ping') && (stgLower.includes('8a') || mode === '8A'))) res.push('8A_CONNECTIVITY_VERIFIED');

                    // Part 8B
                    if (stgLower.includes('8b_topology') || (stgLower.includes('topology') && (stgLower.includes('8b') || mode === '8B')) || (eventType === 'TOPOLOGY_VALIDATED' && (stgLower.includes('8b') || mode === '8B'))) res.push('8B_TOPOLOGY_COMPLETE');
                    if (stgLower.includes('8b_ip') || (stgLower.includes('addressing') && (stgLower.includes('8b') || mode === '8B')) || (eventType === 'ADDRESSING_MATCHED' && (stgLower.includes('8b') || mode === '8B'))) res.push('8B_IP_CONFIGURED');
                    if (stgLower.includes('8b_ospf') || (stgLower.includes('ospf') && (stgLower.includes('8b') || mode === '8B')) || (actLower.includes('router ospf') && (stgLower.includes('8b') || mode === '8B'))) res.push('8B_OSPF_CONFIGURED');
                    if (stgLower.includes('8b_connectivity') || (eventType === 'PING_SUCCESS' && (stgLower.includes('8b') || mode === '8B')) || (actLower.includes('ping') && (stgLower.includes('8b') || mode === '8B'))) res.push('8B_CONNECTIVITY_VERIFIED');
                    break;
                }
                case 9: {
                    const actLower = act.toLowerCase();
