...
async function seed() {
    try {
        console.log('Connecting to database and seeding Experiment 9...');
        const insertSql = `
            INSERT INTO experiments (id, title, aim, total_stages) VALUES
            (9, 'Configuration of Point-to-Point Protocol (PPP) & HDLC Protocol', 'To configure the point-to-point protocol (PPP) on Cisco Packet Tracer and inspect HDLC protocol framing.', 5)
